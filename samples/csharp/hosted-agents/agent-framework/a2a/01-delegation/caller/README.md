...
See [`Program.cs`](src/agent-framework-a2a-caller-responses-dotnet/Program.cs) for the wiring, and [Supported toolbox tools](https://github.com/microsoft-foundry/foundry-samples/blob/main/samples/python/toolbox/SUPPORTED_TOOLBOX_TOOLS.md#a2a-tool-preview) for the `a2a_preview` parameters.
