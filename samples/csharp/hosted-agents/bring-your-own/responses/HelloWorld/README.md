...
azd ai agent init -m https://github.com/microsoft-foundry/foundry-samples/blob/main/samples/dotnet/hosted-agents/bring-your-own/responses/HelloWorld/azure.yaml
...
> `azd ai agent init -m <path-to-repo>/samples/dotnet/hosted-agents/bring-your-own/responses/HelloWorld/azure.yaml`
