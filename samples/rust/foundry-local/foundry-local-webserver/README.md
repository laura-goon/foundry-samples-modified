# Foundry Local Web Server (Rust)

Start a local OpenAI-compatible web server and call it with a standard HTTP client.

> Part of the [Foundry Local samples for Rust](../).
