...
"""Upstream URL + auth resolution for the pipecat-webrtc portal.
...
AGENT_ENV = "PIPECAT_WEBRTC_AGENT_NAME"
LOCAL_ENV = "PIPECAT_WEBRTC_LOCAL_URL"
...
def _build_url(agent_name: str, session_id: str) -> str:
    ...
    if not endpoint:
        raise RuntimeError(
            ...
            "Set it in chat_client/.env or use PIPECAT_WEBRTC_LOCAL_URL."
        )
