...
"""Upstream URL + auth resolution for the livekit-server portal.
...
AGENT_ENV = "LIVEKIT_AGENT_NAME"
LOCAL_ENV = "LIVEKIT_LOCAL_URL"
...
def _build_url(agent_name: str, session_id: str) -> str:
    ...
    if not endpoint:
        raise RuntimeError(
            ...
            "Set it in chat_client/.env or use LIVEKIT_LOCAL_URL."
        )
