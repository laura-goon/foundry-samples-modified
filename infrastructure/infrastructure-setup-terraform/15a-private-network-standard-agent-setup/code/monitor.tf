...
## Create the Azure Monitor Private DNS Zones. The blob zone is intentionally omitted: the
## standard template already creates and links privatelink.blob.core.windows.net.
##
